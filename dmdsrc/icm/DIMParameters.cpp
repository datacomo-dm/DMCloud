...
vector<DataIntegrityTest*> DIMParameters::failed_tests = vector<DataIntegrityTest*>();
...
{
	std::auto_ptr<DIMParameters> icp = std::auto_ptr<DIMParameters>(new DIMParameters());
