...
class DataFormat
{
	bool simpbin;
public:
	/* simple implement binary format in dma */
...
public:
	...
	virtual DataParserAutoPtr   CreateDataParser(std::vector<RCAttrLoad*> attrs, Buffer& buffer, const IOParameters& iop, uint mpr=65536) const = 0;
