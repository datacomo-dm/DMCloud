...
int ib_packn_compress_zlib(const uint * nulls,	/*: nulls 存储缓存      */
...
int ib_packn_decompress_zlib(const uchar * compressed_buf,	/*: 压缩后的缓存        */
...
int ib_packs_compress_zlib(const uint * nulls,	/*: nulls 存储缓存      */
			   const int no_nulls,	/*: null 个数           */
...
int ib_packs_decompress_zlib(const uchar * compressed_buf,	/*: 压缩后的缓存        */
