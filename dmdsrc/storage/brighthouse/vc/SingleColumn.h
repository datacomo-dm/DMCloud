...
public:
	...
	virtual bool RoughNullsOnly(const MIIterator &mit) 
	{ return col->GetPackOntologicalStatus(mit.GetCurPackrow(dim)) == NULLS_ONLY; }
	...
	virtual void GetNotNullValueString(RCBString& s, const MIIterator& mit) { return col->GetNotNullValueString(mit[dim], s); }
