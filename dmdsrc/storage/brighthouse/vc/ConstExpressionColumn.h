...
//			last_val = expr->Evaluate();
	...
	virtual bool RoughNullsOnly(const MIIterator &mit) { return last_val.IsNull(); }
	virtual void RequestEval();
...
protected:
	...
	virtual _int64 DoGetMinInt64(const MIIterator &mit) { return last_val.IsNull() ? NULL_VALUE_64 : last_val.Get64(); }
	virtual _int64 DoGetMaxInt64(const MIIterator &mit) { return last_val.IsNull() ? NULL_VALUE_64 : last_val.Get64(); }
	virtual _int64 DoRoughMin()	{ return last_val.IsNull() ? NULL_VALUE_64 : last_val.Get64(); }
	virtual _int64 DoRoughMax() { return last_val.IsNull() ? NULL_VALUE_64 : last_val.Get64(); }
