...
uint64 Loader::cur_localid = 0;
IBMutex Loader::localid_mutex;
...
void Loader::Init(string bhload_app, IOParameters* io_params)
{
	...
	Loader::BuildId(shared_obj_name);
...
void Loader::BuildId(string& id)
{
	...
	uint64 localid = 0;
	{
		IBGuard localid_guard(Loader::localid_mutex);
		localid = ++Loader::cur_localid;
	}
