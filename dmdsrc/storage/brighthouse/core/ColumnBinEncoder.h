...
//	void Clear();								// clear all encoding data, keep flags
	...
	void PutValue64(unsigned char *buf, _int64 v, bool sec_column, bool update_stats = false);
	void PutValueString(unsigned char *buf, RCBString& v, bool sec_column, bool update_stats = false);
...
public:
	...
	virtual void Encode(unsigned char *buf, unsigned char *buf_sec, _int64 v, bool sec_column, bool update_stats)		{ assert(0); }	// used in special cases only
	virtual void Encode(unsigned char *buf, unsigned char *buf_sec, RCBString& v, bool sec_column, bool update_stats)		{ assert(0); }	// used in special cases only
...
public:
	...
	virtual void Encode(unsigned char *buf, unsigned char *buf_sec, _int64 v, bool sec_column, bool update_stats);
...
public:
	...
	virtual void Encode(uchar* buf, uchar* buf_sec, RCBString& s, bool sec_column, bool update_stats);
	virtual void SetNull(unsigned char* buf, unsigned char* buf_sec);
	virtual bool IsNull(unsigned char* buf, unsigned char* buf_sec);
