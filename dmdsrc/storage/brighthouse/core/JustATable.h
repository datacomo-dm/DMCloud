...
public:
	...
	virtual void LockPackForUse(unsigned attr, _int64 *pahead,unsigned pack_no,ConnectionInfo& conn,Descriptor *pdesc, uint range,void *pf) = 0;
	virtual void PreloadPack(unsigned attr, _int64 *pahead,ConnectionInfo& conn,Descriptor *pdesc) = 0;
	virtual void UnlockPackFromUse(unsigned attr, unsigned pack_no) = 0;
	virtual void WaitPreload(unsigned attr,ulong transid) =0 ;
