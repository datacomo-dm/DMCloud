...
void ColumnBinEncoder::PutValue64(uchar* buf, _int64 v, bool sec_column, bool update_stats)
{
	if(implicit)
		return;
	my_encoder->Encode(buf + val_offset, buf + val_sec_offset, v, sec_column, update_stats);
}

void ColumnBinEncoder::PutValueString(uchar* buf, RCBString& v, bool sec_column, bool update_stats)
{
	if(implicit)
		return;
	my_encoder->Encode(buf + val_offset, buf + val_sec_offset, v, sec_column, update_stats);
...
void ColumnBinEncoder::EncoderInt::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
...
void ColumnBinEncoder::EncoderDecimal::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
	if(null_status > 0 && v == NULL_VALUE_64)
		SetNull(buf, buf_sec);
	else {
...
void ColumnBinEncoder::EncoderDate::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
	if(null_status > 0 && v == NULL_VALUE_64)
		SetNull(buf, buf_sec);
	else
		EncoderInt::Encode(buf, buf_sec, DateSortEncoding(v), false, update_stats);
}
...
void ColumnBinEncoder::EncoderYear::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
	if(null_status > 0 && v == NULL_VALUE_64)
		SetNull(buf, buf_sec);
	else
		EncoderInt::Encode(buf, buf_sec, YearSortEncoding(v), false, update_stats);
}
...
void ColumnBinEncoder::EncoderDouble::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
	if(null_status == 2) {
		if(v == NULL_VALUE_64) {
			SetNull(buf, buf_sec);
...
void ColumnBinEncoder::EncoderText::Encode(uchar* buf, uchar* buf_sec, RCBString& s, bool sec_column, bool update_stats)
{
...
void ColumnBinEncoder::EncoderText_UTF::Encode(uchar* buf, uchar* buf_sec, RCBString& s, bool sec_column, bool update_stats)
{
	if(null_status > 0 && s.IsNull()) {
		SetNull(buf, buf_sec);
		return;
...
void ColumnBinEncoder::EncoderLookup::Encode(uchar* buf, uchar* buf_sec, _int64 v, bool sec_column, bool update_stats)
{
	if(null_status > 0 && v == NULL_VALUE_64)
		SetNull(buf, buf_sec);
	else {
...
void ColumnBinEncoder::EncoderTextStat::Encode(uchar* buf, uchar* buf_sec, RCBString& s, bool sec_column, bool update_stats)
{
	if(null_status > 0 && s.IsNull())
		SetNull(buf, buf_sec);
	else {
...
void ColumnBinEncoder::EncoderTextMD5::Encode(uchar* buf, uchar* buf_sec, RCBString& s, bool sec_column, bool update_stats)
{
	if(s.IsNull()) {
		SetNull(buf, buf_sec);
		return;
