...
public:
	...
	void operator()(Descriptor& desc,Transaction *ptrans=NULL);
private:
    ...
    void TransofrmWithRespectToNulls();
...
public:
	static void EncodeIfPossible(Descriptor& desc, bool for_rough_query, bool additional_nulls,Transaction *ptrans=NULL);
