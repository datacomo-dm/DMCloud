...
public:
	...
	static bool SanityCheck(Item* item, std::set<Item_field*>& ifields, bool toplevel = true);
...
//	void		SetBufsOrParams(BufOfVars* bufs, bool alloc);
	...
	void	CheckDecimalError(int err);
...
#ifndef PURE_LIBRARY
	String		string_result;		// buffer of MySQL type to store string result of expression
#endif
	bool deterministic;
};
