...
class RCDataType;
//0: none,1: load data 2: truncate partition 3: delete row 4:insert row 5: update 6: rename
#define TRANS_ACT_NONE 0
#define TRANS_ACT_LOAD 1
#define TRANS_ACT_TRUNCPART 2
#define TRANS_ACT_DELETE 3
#define TRANS_ACT_INSERT 4
#define TRANS_ACT_UPDATE 5
#define TRANS_ACT_RENAME 6
/*
...
protected:
	...
	int GetLastAction() {return last_action;}
	...
	void SetConnectInfo(ConnectionInfo *pconn);
	//0: none,1: load data 2: truncate partition 3: delete row 4:insert row 5: update 6: rename
	uint last_action;
};
