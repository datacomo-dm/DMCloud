...
/* Modified by DT project--BEGIN--*/
  /* add lines to control index key used in dt tables */
  if(search_flag==HA_READ_AFTER_KEY)
	search_flag=HA_READ_KEY_OR_NEXT;
  else if(search_flag==HA_READ_BEFORE_KEY)
	search_flag=HA_READ_KEY_OR_PREV;
  //nextflag|=SEARCH_SAME;
